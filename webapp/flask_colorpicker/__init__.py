...
class colorpicker(object):
    ...
    def picker(self, ids=[".colorpicker"],
        ...
        @param: cancelText text for 'cancel' button in picker (Default: 'clear')
        @param: chooseText text for 'choose' button in picker (Default: 'Submit')
        """
